...
export const StorySection: React.FC = () => {
  ...
  // Scroll tracker tied perfectly to the scrolling narrative block
  ...
  // Dynamic Scroll-linked Opacities and Positions for each card
  // This completely prevents text/images piling up because each card is only visible in its dedicated scroll window!
  ...
  return (
    <div id="about-us-story" className="bg-[#F4F2EC] font-sans">
      
      {/* Editorial Chapter Header (Intro Section) */}
      <div className="bg-[#F4F2EC] py-20 text-center space-y-4">
        ...
        <h2 className="font-serif text-4xl sm:text-5xl font-light text-stone-900 tracking-tight leading-tight">
          The Story of <span className="font-semibold italic">Morgan Shop</span>
        </h2>
        <div className="h-[1px] w-20 bg-stone-300 mx-auto my-6" />
        <p className="text-sm sm:text-base text-stone-600 font-sans leading-relaxed max-w-2xl mx-auto italic px-4">
      ...
      {/* 
        Immersive full-screen sticky scrolling timeline container.
        This provides a rich 300vh scroll space where components are layered,
        rather than side-by-side split screen which causes content crowding.
      */}
      <div ref={containerRef} className="relative h-[300vh] w-full bg-stone-950">
        
        {/* Sticky stage containing both background visual elements and absolute-centered text cards */}
        <div className="sticky top-0 h-screen w-full overflow-hidden flex items-center justify-center">
          ...
          {/* 
            Only one card is active at a time during the scroll timeline.
            They are centered within the sticky stage to avoid any overlapping bugs!
          */}

          {/* Chapter 1 Card */}
          <motion.div 
            style={{ opacity: opacityCard1, y: yCard1 }}
            className="absolute max-w-xl mx-4 bg-white/95 backdrop-blur-md p-8 sm:p-12 rounded-3xl border border-stone-200 shadow-2xl space-y-4 text-center md:text-left z-10"
          >
            <span className="text-[9px] font-bold tracking-[0.25em] text-amber-600 uppercase block">CHAPTER I</span>
            <h3 className="font-serif text-2xl sm:text-3xl font-light leading-tight text-stone-900">
            ...
            <div className="flex items-center gap-2 pt-2 text-[10px] font-bold text-stone-500 uppercase tracking-widest justify-center md:justify-start">
          ...
          <motion.div 
            ...
            className="absolute max-w-xl mx-4 bg-stone-950/95 text-white backdrop-blur-md p-8 sm:p-12 rounded-3xl border border-stone-800 shadow-2xl space-y-4 text-center md:text-left z-10"
          >
            <span className="text-[9px] font-bold tracking-[0.25em] text-amber-500 uppercase block">CHAPTER III</span>
            <h3 className="font-serif text-2xl sm:text-3xl font-light leading-tight text-stone-100">
            ...
            <div className="flex items-center gap-2 pt-2 text-[10px] font-bold text-amber-500 uppercase tracking-widest justify-center md:justify-start">
          ...
          <div className="absolute right-6 sm:right-10 top-1/2 -translate-y-1/2 z-20 flex flex-col gap-5">
      ...
      <div className="bg-[#F4F2EC] py-24 border-t border-stone-200">
        <div className="max-w-4xl mx-auto px-4 text-center space-y-5">
          ...
          <div className="flex justify-center items-center gap-6 pt-4 text-[10px] text-stone-500 font-bold uppercase tracking-widest">
